...
export class TaskServices {
    static async addTask(projectId: number,userId:number, task: TaskDTO): Promise<void> {
        ...
        (task as Task).user=user;
        (task as Task).project=project;
    ...
    static async updateTask(userId:number,taskId: number, newTask: TaskDTO): Promise<void> {
